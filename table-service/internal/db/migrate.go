...
func SeedBranches(db *sql.DB) error {
	...
	branches := []branchSeed{
		...
		},
		{
			...
			// D13=1-stol, D14=2-stol, D12=3-stol, D6=4-stol, D5=5-stol,
			// D10=6-stol, D4=7-stol, D9=8-stol, D3=9-stol(VIP)
			channels: []int{13, 14, 12, 6, 5, 10, 4, 9, 3},
		},
	}
